...
let canvas, ctx;
let renderer, stage;
let canvasDiv = document.getElementsByClassName("homeCanvas")[0];
let sw = canvasDiv.clientWidth;
let sh = canvasDiv.clientHeight;
...
function canvasResize() {
    sw = canvasDiv.clientWidth;
    sh = canvasDiv.clientHeight;
